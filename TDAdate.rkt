...
;Capa selector.
;Dom: las 3 funciones tienen por entrada un date.
;____
...
;Dom: un lista.
;Rec: un booleano.
;Función que entrega un true si la lista corresponde a un date, sino un false.
